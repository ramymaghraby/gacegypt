  ...
  >
      <div class="layout-config-panel flex flex-column">
          <div class="px-3 pt-3">
              ...
              <span
                  >Ultima offers different themes for layout, topbar, menu
                  etc.</span
              >
          </div>
          ...
          <div class="layout-config-options p-3">
              ...
              <div class="flex">
                  ...
                  >
                      <p-radioButton
                          ...
                          value="both"
                          [(ngModel)]="app.inlineMenuPosition"
                          inputId="inlineMenuPosition3"
                      ></p-radioButton>
                      <label
                          for="inlineMenuPosition3"
                          [ngClass]="{
                              'ml-2': !app.isRTL,
                              'mr-2': app.isRTL
                          }"
              ...
              <p-inputSwitch
                  [ngModel]="app.isRTL"
                  (onChange)="appMain.onRTLChange($event)"
                  styleClass="block"
              ></p-inputSwitch>
              ...
              <p *ngIf="app.layoutMode === 'dark'">
                  Menu themes are only available in light mode by design
  ...
  scale = 14;
    ...
    onLayoutModeChange(event, mode) {
        ...
        if (mode === 'dark') {
            ...
            appLogoLink.src = 'assets/layout/images/GAC.png';
        } else {
